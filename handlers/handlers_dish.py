...
@router.get('/{menu_id}/submenus/{submenu_id}/dishes/{id}', response_model=None)
async def get_dish(id: uuid.UUID, db: Session = Depends(get_db)) -> schemas.Dish | JSONResponse:
